...
import com.jaqxues.sniptools.ui.views.ui.home.HomeFragment
...
class MainActivity : AppCompatActivity(), DynamicNavigationView.NavigationFragmentListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navView: DynamicNavigationView = findViewById(R.id.nav_view)
...
//        navView.setupWithNavController(navController)
    ...
    override fun selectedFragment(fragment: NavFragment) {
